  ...
  def facebook
    if params[:facebook_access_token]
      ...
      if user
        ...
        user = User.new(email: user_data['email'], uuid: user_data['uuid'], provider: 'facebook', image: user_data['picture']['data']['url'], password: Devise.friendly_token[0, 20])
      ...
      json_response 'Missing facebook access to token', false, {}, :unprocessable_entity
    end
  end
end